...
export default function UsagePage() {
  ...
  if (adminLoading) return <LoadingSpinner fullPage size="md" />;
  ...
  return (
    <PageContainer>
      <div className="flex items-center gap-2">
        ...
        <PageHeader title="Nutzung" description="Token-Verbrauch und Kosten für den aktuellen Workspace." badge="Admin" />
      </div>
