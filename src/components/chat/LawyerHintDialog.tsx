      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          <div className="flex items-center gap-2 mb-1">
            ...
            <AlertDialogTitle className="text-base">Hinweis zur Verschwiegenheitspflicht</AlertDialogTitle>
          </div>
          <AlertDialogDescription className="text-[13px] leading-relaxed space-y-3">
            <p>
              Als Berufsträger unterliegen Sie der <strong>anwaltlichen Verschwiegenheitspflicht</strong> 
              (§ 43a Abs. 2 BRAO / § 9 RAO / Art. 13 BGFA).
            </p>
            <p>Eingaben werden zur Verarbeitung an KI-Modelle übermittelt. Bitte beachten Sie:</p>
            <ul className="list-disc pl-4 space-y-1 text-muted-foreground">
              <li><strong>Pseudonymisieren</strong> Sie personenbezogene Mandantendaten vor der Eingabe</li>
              <li>Aktivieren Sie den <strong>Datenschutz-Modus</strong> in den Einstellungen</li>
              <li>Holen Sie ggf. die <strong>Einwilligung Ihres Mandanten</strong> ein — eine Vorlage finden Sie unten</li>
            </ul>
            <p className="text-[12px] text-muted-foreground/60 mt-2">
              Gemäß Art. 50 AI Act sind Sie zudem verpflichtet, Mandanten und Gerichte über den Einsatz von KI zu informieren.
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter className="flex-col sm:flex-row gap-2">
          <Button variant="outline" size="sm" className="text-[12px]" onClick={downloadTemplatePDF}>
            📄 Entbindungsvorlage herunterladen
          </Button>
          <AlertDialogAction onClick={() => { localStorage.setItem("lawyer_hint_dismissed", "true"); onOpenChange(false); }}>
            Verstanden
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
